...
const CAMERAS = [
  ...
  { id: 'fujifilm-x-t5', brand: 'Fujifilm', name: 'X-T5', mount: 'X', sensor: 'APS-C',
    ...
    depthInclEyecup: true, evf: 'center', grip: 'small', photos: {
      top:   { src: 'images/fujifilm-x-t5-top.png', widthMM: 129.5, backFrac: 0.152 },
      front: { src: 'images/fujifilm-x-t5-front.png', widthMM: 129.5 },
      rear: { src: 'images/fujifilm-x-t5-rear.png', widthMM: 129.5 },
    },
  ...
  { id: 'fujifilm-x-t50', brand: 'Fujifilm', name: 'X-T50', mount: 'X', sensor: 'APS-C',
    ...
    depthInclEyecup: true, evf: 'center', grip: 'small', photos: {
      top:   { src: 'images/fujifilm-x-t50-top.png', widthMM: 123.8, backFrac: 0.2 },
      front: { src: 'images/fujifilm-x-t50-front.png', widthMM: 123.8 },
    },
  ...
  { id: 'fujifilm-x-h2', brand: 'Fujifilm', name: 'X-H2', mount: 'X', sensor: 'APS-C',
    ...
    depthInclEyecup: true, evf: 'center', grip: 'deep', photos: {
      front: { src: 'images/fujifilm-x-h2-front.png', widthMM: 136.3 },
      rear: { src: 'images/fujifilm-x-h2-rear.png', widthMM: 136.3 },
    },
  ...
  { id: 'fujifilm-x-h2s', brand: 'Fujifilm', name: 'X-H2S', mount: 'X', sensor: 'APS-C',
    widthMM: 136.3, heightMM: 92.9, depthMM: 84.6, depthMinMM: 42.8, weightG: 660,
    depthInclEyecup: true, evf: 'center', grip: 'deep', photos: {
      front: { src: 'images/fujifilm-x-h2s-front.png', widthMM: 136.3 },
    },
  ...
  { id: 'fujifilm-x-m5', brand: 'Fujifilm', name: 'X-M5', mount: 'X', sensor: 'APS-C',
    ...
    evf: 'none', grip: 'flat', photos: {
      top:   { src: 'images/fujifilm-x-m5-top.png', widthMM: 111.9, backFrac: 0.0 },
      front: { src: 'images/fujifilm-x-m5-front.png', widthMM: 111.9 },
      rear: { src: 'images/fujifilm-x-m5-rear.png', widthMM: 111.9 },
    },
  ...
  { id: 'fujifilm-x100vi', brand: 'Fujifilm', name: 'X100VI', mount: 'fixed', sensor: 'APS-C',
    ...
    photos: {
      top:   { src: 'images/fujifilm-x100vi-top.png', widthMM: 128.0, backFrac: 0.071, includesLens: true },
      front: { src: 'images/fujifilm-x100vi-front.png', widthMM: 128.0 },
      rear: { src: 'images/fujifilm-x100vi-rear.png', widthMM: 128.0 },
    },
  ...
  { id: 'fujifilm-x-pro3', brand: 'Fujifilm', name: 'X-Pro3', mount: 'X', sensor: 'APS-C',
    ...
    depthInclEyecup: true, evf: 'corner', grip: 'small', photos: {
      front: { src: 'images/fujifilm-x-pro3-front.png', widthMM: 140.5 },
      rear: { src: 'images/fujifilm-x-pro3-rear.png', widthMM: 140.5 },
    },
  ...
  { id: 'fujifilm-x-e4', brand: 'Fujifilm', name: 'X-E4', mount: 'X', sensor: 'APS-C',
    ...
    depthInclEyecup: true, evf: 'corner', grip: 'flat', photos: {
      top:   { src: 'images/fujifilm-x-e4-top.png', widthMM: 121.3, backFrac: 0.101 },
      front: { src: 'images/fujifilm-x-e4-front.png', widthMM: 121.3 },
      rear: { src: 'images/fujifilm-x-e4-rear.png', widthMM: 121.3 },
    },
  ...
  { id: 'om-system-om-1-ii', brand: 'OM System', name: 'OM-1 Mark II', mount: 'MFT', sensor: 'Micro Four Thirds',
    ...
    evf: 'center', grip: 'deep', photos: {
      top:   { src: 'images/om-system-om-1-ii-top.png', widthMM: 134.8, backFrac: 0.111 },
      front: { src: 'images/om-system-om-1-ii-front.png', widthMM: 134.8 },
    },
  ...
  { id: 'om-system-om-3', brand: 'OM System', name: 'OM-3', mount: 'MFT', sensor: 'Micro Four Thirds',
    ...
    evf: 'center', grip: 'flat', photos: {
      top:   { src: 'images/om-system-om-3-top.png', widthMM: 139.3, backFrac: 0.105, includesLens: true },
      front: { src: 'images/om-system-om-3-front.png', widthMM: 139.3 },
      rear: { src: 'images/om-system-om-3-rear.png', widthMM: 139.3 },
    },
  ...
  { id: 'om-system-om-5', brand: 'OM System', name: 'OM-5', mount: 'MFT', sensor: 'Micro Four Thirds',
    ...
    evf: 'center', grip: 'small', photos: {
      top:   { src: 'images/om-system-om-5-top.png', widthMM: 125.3, backFrac: 0.174 },
      front: { src: 'images/om-system-om-5-front.png', widthMM: 125.3 },
    },
  ...
  { id: 'om-system-om-5-ii', brand: 'OM System', name: 'OM-5 Mark II', mount: 'MFT', sensor: 'Micro Four Thirds',
    ...
    evf: 'center', grip: 'small', photos: {
      top:   { src: 'images/om-system-om-5-ii-top.png', widthMM: 125.3, backFrac: 0.166 },
      front: { src: 'images/om-system-om-5-ii-front.png', widthMM: 125.3 },
      rear: { src: 'images/om-system-om-5-ii-rear.png', widthMM: 125.3 },
    },
  ...
  { id: 'olympus-e-m10-iv', brand: 'Olympus', name: 'OM-D E-M10 Mark IV', mount: 'MFT', sensor: 'Micro Four Thirds',
    ...
    evf: 'center', grip: 'small', photos: {
      top:   { src: 'images/olympus-e-m10-iv-top.png', widthMM: 121.7, backFrac: 0.136, includesLens: true },
      front: { src: 'images/olympus-e-m10-iv-front.png', widthMM: 121.7 },
      rear: { src: 'images/olympus-e-m10-iv-rear.png', widthMM: 121.7 },
    },
  ...
  { id: 'olympus-e-p7', brand: 'Olympus', name: 'PEN E-P7', mount: 'MFT', sensor: 'Micro Four Thirds',
    ...
    evf: 'none', grip: 'flat', photos: {
      top:   { src: 'images/olympus-e-p7-top.png', widthMM: 118.3, backFrac: 0.0, includesLens: true },
      front: { src: 'images/olympus-e-p7-front.png', widthMM: 118.3 },
      rear: { src: 'images/olympus-e-p7-rear.png', widthMM: 118.3 },
    },
