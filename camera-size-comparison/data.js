...
const CAMERAS = [
  ...
  { id: 'fujifilm-x-t5', brand: 'Fujifilm', name: 'X-T5', mount: 'X', sensor: 'APS-C',
    ...
    depthInclEyecup: true, evf: 'center', grip: 'small', photos: {
      front: { src: 'https://commons.wikimedia.org/wiki/Special:FilePath/Fujifilm%20X-T5%204%20nov%202022a.jpg' },
      rear:  { src: 'https://commons.wikimedia.org/wiki/Special:FilePath/Fujifilm%20X-T5%204%20nov%202022f.jpg' },  // candidate — aspect matches body face; verify it is the back
    },  // Commons product shots — angles/crops unverified; recalibrate widthMM after checking
  ...
  { id: 'fujifilm-x100vi', brand: 'Fujifilm', name: 'X100VI', mount: 'fixed', sensor: 'APS-C',
    ...
    photos: {
      front: { src: 'https://commons.wikimedia.org/wiki/Special:FilePath/Fujifilm%20X100VI%2025%20may%202024a.jpg' },  // CC0
      rear:  { src: 'https://commons.wikimedia.org/wiki/Special:FilePath/Fujifilm%20X100VI%2025%20may%202024b.jpg' },  // candidate — verify it is the back
    },  // Commons product shots — angles/crops unverified; recalibrate widthMM after checking
  ...
  { id: 'om-system-om-5', brand: 'OM System', name: 'OM-5', mount: 'MFT', sensor: 'Micro Four Thirds',
    ...
    evf: 'center', grip: 'small', photos: {
      front: { src: 'https://commons.wikimedia.org/wiki/Special:FilePath/OM%20System%20OM-5%2022%20nov%202022a.jpg' },
      top:   { src: 'https://commons.wikimedia.org/wiki/Special:FilePath/OM%20System%20OM-5%2022%20nov%202022e.jpg', includesLens: false },  // candidate — wide aspect suggests top plate; verify + set backFrac
    },  // Commons product shots — angles/crops unverified; recalibrate widthMM after checking
